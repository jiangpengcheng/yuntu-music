...
音乐可用性和音质取决于网易云账号、曲目授权和设备解码能力。项目不提供会员解锁、离线曲库或手机蓝牙音乐信息来源。请避免同时运行多个播放器争夺音频焦点。
...
```sh
adb logcat -v threadtime -s YuntuDirect:I YuntuNetwork:I YuntuStartup:I AndroidRuntime:E
```
